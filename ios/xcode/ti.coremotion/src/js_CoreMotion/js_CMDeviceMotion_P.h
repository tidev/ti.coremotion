...
extern JSValueRef HyperloopCMAccelerationToJSValueRef(JSContextRef,CMAcceleration *);
extern JSValueRef HyperloopCMAttitudeToJSValueRef(JSContextRef,CMAttitude *);
extern JSValueRef HyperloopCMCalibratedMagneticFieldToJSValueRef(JSContextRef,CMCalibratedMagneticField *);
extern JSValueRef HyperloopCMDeviceMotionToJSValueRef(JSContextRef,CMDeviceMotion *);
extern JSValueRef HyperloopCMRotationRateToJSValueRef(JSContextRef,CMRotationRate *);
