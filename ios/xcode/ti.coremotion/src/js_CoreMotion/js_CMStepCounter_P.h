...
extern Block_void__B__NSInteger__NSDate_P__NSError_P_ HyperloopJSValueRefTovoid__B__NSInteger__NSDate_P__NSError_P_(JSContextRef,JSObjectRef,JSValueRef,JSValueRef*,bool*);
extern Block_void__B__NSInteger__NSError_P_ HyperloopJSValueRefTovoid__B__NSInteger__NSError_P_(JSContextRef,JSObjectRef,JSValueRef,JSValueRef*,bool*);
extern Class HyperloopJSValueRefToClass(JSContextRef,JSValueRef,JSValueRef*,bool*);
extern JSValueRef HyperloopCMStepCounterToJSValueRef(JSContextRef,CMStepCounter *);
